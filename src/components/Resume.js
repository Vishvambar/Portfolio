...
const Resume = () => {
  const skills = {
    programming: ['JavaScript', 'Python', 'C++', 'Java', 'SQL'],
    web: ['React.js', 'Node.js', 'Express.js', 'HTML5', 'CSS3', 'Tailwind CSS'],
    tools: ['Git', 'GitHub', 'Postman', 'Vercel', 'Render', 'OpenAI API', 'VS Code'],
  ...
  const projects = [
    ...
    },
    {
      ...
      github: "https://github.com/vishvambar/notes-app-with-auth"
    },
    {
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900 print:bg-white print:text-black" id="resume">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 print:text-black">
            Resume
          </h2>
          <div className="flex justify-center space-x-4 print:hidden">
            <button
              onClick={handleDownload}
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors duration-300 flex items-center"
            >
            ...
            <button
              onClick={handleDownload}
              className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-6 py-2 rounded-lg font-semibold transition-colors duration-300 flex items-center dark:border-blue-400 dark:text-blue-400"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-4xl mx-auto bg-white dark:bg-gray-800 print:bg-white print:shadow-none shadow-2xl rounded-lg p-8 print:p-0"
        >
          {/* Header Section */}
